...
$commands = [
    ...
    'CREATE TABLE chattr.surveys (id INT NOT NULL AUTO_INCREMENT, name varchar(255), live BOOL NOT NULL DEFAULT 1, PRIMARY KEY (id))',
...
create_survey('Who east the most Pizza?', ['John', 'Hassan', 'Reiss', 'Brandon', 'Robin']);
